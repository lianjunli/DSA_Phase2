        ...
        if channel_alloc_type1:
            ...
            for c1 in channel_alloc_type1:
                ...
                if (Case == '1'): # with r_min_scale
                    ...
                    power_alloc_GP_1 = PA_GP_MCS_minRate(channel_alloc_optimizer, h_minRate_1, env, priority_optimizer,
                                                         SU_power_optimizer, QoS_optimizer * alpha, SNR_gap_optimizer,
                ...
                if (Case == '2'): # with r_min_scale and fading margin
                    ...
                    power_alloc_GP_2 = PA_GP_MCS_minRate(channel_alloc_optimizer, h_minRate_2, env, priority_optimizer,
                                                         SU_power_optimizer, QoS_optimizer*alpha, SNR_gap_optimizer,
                ...
                if (Case == '1'):
                    ...
                    objective_list_DC_1['total'].append(objective_value(channel_alloc_optimizer, power_alloc_DC_1,
                                                                        priority_optimizer, h_DC_1, env,
                                                                        SNR_gap_optimizer))
                    # power allocation update
                    power_engine = PA_DC_MCS_minRate_channelCap(power_alloc_DC_1, channel_alloc_optimizer, h_DC_1, env,
                                                                priority_optimizer, SU_power_optimizer, QoS_optimizer*alpha,
                                                                SNR_gap_optimizer, QAM_cap_optimizer, channel_cap_optimizer,
                                                                objective_list_DC_1, update_order_optimizer,h_minRate_1)
                ...
                if (Case == '2'):
                    ...
                    # Record the objective value
                    objective_list_DC_2['total'].append(objective_value(channel_alloc_optimizer, power_alloc_DC_2,
                                                                        priority_optimizer, h_DC_2, env,
                                                                        SNR_gap_optimizer))
                    # power allocation update
                    power_engine = PA_DC_MCS_minRate_channelCap(power_alloc_DC_2, channel_alloc_optimizer, h_DC_2, env,
                                                                priority_optimizer, SU_power_optimizer, QoS_optimizer*alpha,
                                                                SNR_gap_optimizer, QAM_cap_optimizer, channel_cap_optimizer,
                                                                objective_list_DC_2, update_order_optimizer,h_minRate_2)
                    ...
                    for i in range(n_cluster_optimizer):
                        ...
                        for tx in range(n_user_cluster):
                            for rx in range(n_user_cluster):
                                if (rx == tx):
                                    continue
                                rate = rate_SU(i, tx, rx, power_alloc_DC_1, h_all, priority_optimizer, env, SNR_gap_optimizer)
                    ...
                    for i in range(n_cluster_optimizer):
                        ...
                        for tx in range(n_user_cluster):
                            for rx in range(n_user_cluster):
                                if (rx == tx):
                                    continue
                                rate = rate_SU(i, tx, rx, power_alloc_DC_2, h_all, priority_optimizer, env, SNR_gap_optimizer)
                ...
                for c1 in channel_alloc_type1:
                    ...
                    if (Case == '1'):
                        ...
                        objective_list_DC_1['total'].append(objective_value(channel_alloc_optimizer, power_alloc_DC_1,
                                                                            ...
                                                                            SNR_gap_optimizer))
                        # power allocation update
                        power_engine = PA_DC_MCS_minRate_channelCap(power_alloc_DC_1, channel_alloc_optimizer, h_DC_1,
                                                                    env,
                    ...
                    if (Case == '2'):
                        ...
                        objective_list_DC_2['total'].append(objective_value(channel_alloc_optimizer, power_alloc_DC_2,
                                                                            ...
                                                                            SNR_gap_optimizer))
                        # power allocation update
                        power_engine = PA_DC_MCS_minRate_channelCap(power_alloc_DC_2, channel_alloc_optimizer, h_DC_2,
                                                                    env,
                                                                    priority_optimizer, SU_power_optimizer,
                                                                    QoS_optimizer * alpha,
                                                                    SNR_gap_optimizer, QAM_cap_optimizer,
