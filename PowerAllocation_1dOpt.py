...
def PA_1dOpt(h, B, noise_vec_cg, SU_power_optimizer, QoS_optimizer,SNR_gap_optimizer, channel_alloc_optimizer, priority_optimizer, fsb_power):
    ...
    for j in range(n_cluster):
        rate_cluster = capacity_SU(power_vec[j, :], j, channel_alloc_optimizer, power_vec,
    ...
    while True:
        ...
        power_vec[indices_rounddown] = power_vec[indices_rounddown] - unit_power
